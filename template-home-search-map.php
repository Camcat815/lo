...
<div id="map-container" class="fullwidth-home-map">
	...
	<div class="main-search-inner">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<?php echo do_shortcode('[listeo_search_form action=' . get_post_type_archive_link('listing') . ' source="search_on_home_page" custom_class="main-search-form"]') ?>
				</div>
			</div>
		</div>
...
while (have_posts()) : the_post();
	...
	<div class="container <?php if ($layout == 'full-width') { ?> content-container <?php }
