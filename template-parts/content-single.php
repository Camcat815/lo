    ...
    <a href="<?php the_permalink(); ?>"><h1><?php the_title(); ?></h1></a>
      ...
      if(!empty($share_options)) {
        ...
        <ul class="share-buttons margin-top-40 margin-bottom-0">
          ...
          <?php if (in_array("twitter", $share_options)) { ?><li><?php echo '<a target="_blank" class="twitter-share" href="https://twitter.com/share?url=' . $url . '&amp;text=' . esc_attr($summary ). '" title="' . esc_html__( 'Twitter', 'listeo' ) . '"><i class="fa-brands fa-x-twitter"></i> Share</a></a>'; ?></li><?php } ?>
